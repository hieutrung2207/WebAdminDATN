...
<?php
  ...
  $response = $userService->getAllUsers()->getData();
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item " href="home.php"><i class='app-menu__icon bx bx-tachometer'></i><span class="app-menu__label">Trang chủ</span></a></li>
            <!-- Quản lí khách hàng -->
            <li><a class="app-menu__item active" href="quanlinguoidung.php"><i class='app-menu__icon bx bx-user-voice'></i><span class="app-menu__label">Quản lý khách hàng</span></a></li>
            <!-- Quản lí sản phẩm -->
