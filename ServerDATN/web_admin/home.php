<?php
  ...
  $resutlBook = $bookService -> getAllBooks()->getData();


  $userService = new UserServices();
  $resutlUser = $userService -> getAllUsers() ->getData();


  $totalUser = count($resutlUser);
  $totalBook = count($resutlBook);
?>
<!DOCTYPE html>
<html lang="en">
...
<body onload="time()" class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user">
            <div>
                <img class="app-sidebar__user-avatar" onclick="window.location.href = 'home.php'"
                    src="images/logo_admin.png" width="50px" height="50px">
        ...
        <ul class="app-menu">
            ...
            <!-- Trang chủ -->
            <li><a class="app-menu__item active" href="home.php"><i class='app-menu__icon bx bx-tachometer'></i><span class="app-menu__label">Trang chủ</span></a></li>
            <!-- Quản lí khách hàng -->
    ...
    <!--===============================================================================================-->
    <script type="text/javascript" src="js/doc/plugins/chart.js"></script>
    <!--===============================================================================================-->
