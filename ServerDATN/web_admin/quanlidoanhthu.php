...
<body onload="time()" class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <!-- Báo cáo doanh thu -->
            <li><a class="app-menu__item active" href="quanlidoanhthu.php"><i class='app-menu__icon bx bx-pie-chart-alt-2'></i><span class="app-menu__label">Báo cáo doanh thu</span></a>
            </li>
        </ul>
    </aside>
